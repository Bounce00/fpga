...
#ifndef __awgn_top_mul_mul_eOg__HH__
#define __awgn_top_mul_mul_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(awgn_top_mul_mul_eOg) {
    ...
    SC_CTOR(awgn_top_mul_mul_eOg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
